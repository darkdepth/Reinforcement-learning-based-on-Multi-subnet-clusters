        ...
        with sess.as_default(), sess.graph.as_default():
            while not coord.should_stop():
                ...
                while not d:
                        ...
                        for i in range(3):
                            ...
                            for j in range(3 - i):
                                ...
                                while do_again:
                                    ...
                                    if locks_all[tem_Index1][1] or locks_all[tem_Index2][1]:
                                      if locks_all[tem_Index1][1]:
                                        tem_Index1 = (tem_Index1+1)%4
                                      if locks_all[tem_Index2][1]:
                                        tem_Index2 = int(end - (i + 1) * 4) + (tem_Index2+1)%4
                                      continue
                                    do_again = False
                                #do_again = True
                                sess.run(self.update_ops[tem_Index1][tem_Index2])
                                locks_all[int(tem_Index2)][1] = 1
                                locks_all[int(tem_Index2)][0] = GLOBAL_STEP
                        ...
                        for i in range(3):
                            ...
                            if judge:
                              for j in range(2):
                                ...
                                locks_all[int(tem_Index1)][1] = 1
                                locks_all[int(tem_Index1)][0] = GLOBAL_STEP
                              judge = False
                                ...
                                for j in range(3 - i):
                                    ...
                                    if random.random() * (num_workers + 1) <= 1:
                                        ...
                                        while do_again:
                                            ...
                                            if locks_all[tem_Index1][1]:
                                                tem_Index1 = int(end - (i + 1) * 4) + (tem_Index1 + 1) % 4
                                                continue
                                            do_again = False
                    ...
                    for i_tem in range(num_workers):
                        if (locks_all[i_tem][0]-GLOBAL_STEP)/150!=0:
                            locks_all[i_tem][1] = 0 
...
lock = threading.Lock()
rEward_dic = {}
locks_all = [[0]*2]*num_workers
print(locks_all)
print(locks_all[31][0])
print(locks_all[31][1])
